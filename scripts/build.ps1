...
.DESCRIPTION
    Produces everything a release needs into dist\:
        ...
        Install-ArcGISProMCP.ps1     one self-contained file: the add-in is
...
.EXAMPLE
    .\scripts\build.ps1
    # dist\ArcGISProMCP.esriAddinX and dist\Install-ArcGISProMCP.ps1
...
<#
    ...
    Version $version, built $built, $signedNote.
...
$outputPath = Join-Path $dist "Install-ArcGISProMCP.ps1"
...
[void][System.Management.Automation.Language.Parser]::ParseFile(
    $outputPath, [ref]$null, [ref]$errors)
if ($errors) {
...
Write-Host "  powershell -ExecutionPolicy Bypass -File dist\Install-ArcGISProMCP.ps1"
